...
IO = "/home/kumarasw/meta-ood/results"
Detectron_PanopticDeepLab_Config = "/home/kumarasw/meta-ood/src/config/panopticDeeplab/panoptic_deeplab_R_52_os16_mg124_poly_90k_bs32_crop_512_1024_dsconv.yaml"
Detectron_DeepLab_Config = "/home/kumarasw/meta-ood/src/config/deeplab/deeplab_v3_plus_R_103_os16_mg124_poly_90k_bs16.yaml"
...
class cs_coco_roots:
    ...
    #init_ckpt   = "/home/kumarasw/meta-ood/weights/panoptic_deeplab_model_final_23d03a.pkl"
    init_ckpt = "/home/kumarasw/meta-ood/weights/deeplab_model_final_a8a355.pkl"
...
class fs_roots:
    ...
    io_root = os.path.join("/home/kumarasw/meta-ood/")
    weights_dir = os.path.join(io_root, "weights/")
