...
def calculate_statistics(train_loader, net):
    ...
    for i, data in enumerate(train_loader):
        ...
        if i % 50 == 49 or i == len(train_loader) - 1:
            ...
            np.save(f'/home/kumarasw/Thesis/Standardized-max-logits/stats/{args.dataset[0]}_mean.npy', mean_dict)
            np.save(f'/home/kumarasw/Thesis/Standardized-max-logits/stats/{args.dataset[0]}_var.npy', var_dict)
