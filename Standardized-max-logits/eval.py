...
if __name__ == '__main__':
    ...
    image_root_path = os.path.join(ood_data_root)
    mask_root_path = os.path.join(ood_data_root)
    ...
    for root, _, filenames in os.walk(os.path.join(ood_data_root)):
