...
def training_routine(config):
    ...
    roots = config.roots
    dataset = config.dataset('train', None, roots.cs_root, roots.coco_root, params.ood_subsampling_factor, cs_split="train", coco_split="val")
    ...
    for epoch in range(start_epoch, start_epoch + epochs):
        ...
        trainloader = config.dataset('train', transform, roots.cs_root, roots.coco_root, params.ood_subsampling_factor, cs_split="train", coco_split="val")
