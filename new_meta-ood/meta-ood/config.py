...
VALSET      = VALSETS[1]
MODEL       = MODELS[0]
IO          = "/home/kumarasw/new_meta-ood/meta-ood/results"
...
class cs_coco_roots:
    ...
    """
    model_name  = MODEL
    init_ckpt = "/home/kumarasw/new_meta-ood/meta-ood/weights/cityscapes_best.pth"
...
class fs_roots:
    ...
    io_root = os.path.join("/home/kumarasw/new_meta-ood/meta-ood/")
    weights_dir = os.path.join(io_root, "weights/")
